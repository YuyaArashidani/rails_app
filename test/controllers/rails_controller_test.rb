...
class RailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rail" do
    assert_difference("Rail.count") do
      post rails_url, params: { rail: { generate: @rail.generate, name: @rail.name, role: @rail.role, scaffold: @rail.scaffold } }
    end
  ...
  test "should update rail" do
    patch rail_url(@rail), params: { rail: { generate: @rail.generate, name: @rail.name, role: @rail.role, scaffold: @rail.scaffold } }
